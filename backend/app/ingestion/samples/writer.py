...
# File: backend/app/ingestion/samples/writer.py
...
from app.ingestion.fixtures.naming import format_fixture_date
...
from app.ingestion.normalization.url.sanitize import sanitize_job_url
